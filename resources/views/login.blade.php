...
<head>
    ...
    <style>
        .cx019djj281 {
            background: linear-gradient(145deg, rgba(90, 120, 100, 1) 41%, rgba(300, 150, 150, 1) 100%)
        }
        .qty3891nb03 {
            background: #0196bb;
        ...
        .btn7328pqra9 {
            all: unset;
            background: linear-gradient(86deg, rgba(212, 112, 182, 1) 0%, rgba(134, 112, 150, 1) 100%);
            padding: 5px 20px;
            color: white;
            border-radius: 15px;
        }
